  ...
  try {
    const chatCompletion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert resume writer. Help users create professional, impactful resume content that uses action verbs, quantifiable achievements, and follows modern resume best practices."
        },
        {
          role: "user",
          content: `Help me create professional resume content based on the following information:
  ...
  try {
    const chatCompletion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert resume writer. Help users improve their resume content based on feedback while maintaining professionalism and impact."
        },
        {
          role: "user",
